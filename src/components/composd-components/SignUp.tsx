...
const formSchema = z.object({
    username: z
        .string()
        .min(4, "min characters is 4")
        .max(30, "max characters is 30")
        .nonempty("cann't be empty ")
        .refine(
            (val) => {
                return isNaN(Number(val));
            },
            {
                message: "username must include characters",
            }
        ),
        ...
        if (error) {
            ...
            if (status == 422) {
                toast("Email Already Exists", {
                    ...
                    description: "Please Choose Another Account",
