import MainLink from "@/app/notes/_mainLink/MainLink";
...
export function AppSidebar() {
    return (
        <Sidebar>
            <SidebarHeader>
                <section className=" mb-5 pt-5 px-3">
                    <svg
                    ...
                    <li>
                        <MainLink to="/notes/all">
                            <div className=" flex items-center gap-x-2">
                                <Home width={20} />
                                <p className=" text-[0.9rem]"> All Notes</p>
                            </div>
                        </MainLink>
                    </li>
                    <li>
                        <MainLink to="/notes/archived">
                            <div className=" flex items-center gap-x-2">
                                <Archive width={20} />
                                <p className=" text-[0.9rem]">Archived Notes</p>
                            </div>
                        </MainLink>
                    </li>
                </ul>
